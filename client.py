...
# Now we define a method to receive the messages and display them
def receive():
    while True:
        try:
...
# because the mainloop method will block the rest of our script we used multithreading for receiving
